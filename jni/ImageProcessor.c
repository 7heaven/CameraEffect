...
JNIEXPORT void JNICALL Java_com_example_cameraeffect_ImageEffect_reverseBitmap(JNIEnv * env, jobject obj, jobject sourceBitmap, jobject destBitmap){
...
JNIEXPORT void JNICALL Java_com_example_cameraeffect_ImageEffect_convertToGray(JNIEnv * env, jobject obj, jobject bitmapColor, jobject bitmapGray){
...
JNIEXPORT void JNICALL Java_com_example_cameraeffect_ImageEffect_reverseAndGray(JNIEnv * env, jobject obj, jobject bitmapColor, jobject bitmapGray){
...
JNIEXPORT void JNICALL Java_com_example_cameraeffect_ImageEffect_colorMatrix(JNIEnv * env, jobject obj, jobject sourceBitmap, jobject destBitmap, jfloatArray matrix){
...
JNIEXPORT void JNICALL Java_com_example_cameraeffect_ImageEffect_convolutionFilter(JNIEnv * env, jobject obj, jobject sourceBitmap, jobject destBitmap, jfloatArray matrix, jfloat divisor, jfloat bias){
...
JNIEXPORT void JNICALL Java_com_example_cameraeffect_ImageEffect_decodeYUV420SP(JNIEnv * env, jobject obj, jintArray rgb, jbyteArray yuv420sp, jint width, jint height){
	jint *p_rgb = (*env)->GetIntArrayElements(env, rgb, 0);
	jbyte *p_yuv = (*env)->GetByteArrayElements(env, yuv420sp, 0);

	decodeYUV420SP((int *) p_rgb, (unsigned char *) p_yuv, (int) width, (int) height);
